...
class ScreenOnOffReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (powerBtnTapCount == 3) { // ?
            ...
            val getShared = context.getSharedPreferences("demo", Context.MODE_PRIVATE) // demo?
            ...
            Value = getShared.getString("msg", "I am in danger, please come fast...")!!
                .trim { it <= ' ' }
            ...
            ?.addOnCompleteListener(OnCompleteListener<Location?> { task ->
                ...
                if (location != null) {
                    try {
                        ...
                        Message = Message + "I am at " + addresses!![0].latitude +
    ...
    companion object {
        const val SCREEN_TOGGLE_TAG: String = "SCREEN_TOGGLE_TAG"
    }
}